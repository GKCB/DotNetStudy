...
namespace _02求数组的最大值
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //DelCompare del = C1;
            //object max = GetMax(nums, del);

            //object[] names = { "张三", "李四", "王五", "zadsafafewvwevewfwe"};
            //object max = GetMax(names, C2);
            object[] pers = { new Person() { Name = "张三", Age = 19 }, 
                                new Person() { Name = "李四", Age = 29 } };
            //object max = GetMax(pers, 
            //        delegate(object o1, object o2) { return ((Person)o1).Age - ((Person)o2).Age; });
            object max = GetMax(pers, 
                (o1, o2) => { return ((Person)o1).Age - ((Person)o2).Age; });
